Public Class TSFinalProject
    ...
    Private Sub TSDisplayGraph_Click(sender As Object, e As EventArgs) Handles TSDisplayGraph.Click
        ...
        TSgr.DrawLine(Pens.Black, 65, 210 - finalgrade * 2, 75, 210 - finalgrade * 2) 'draws the lower tick mark
        Dim avgLabel As String = "Avg Grade"
        TSgr.DrawString(avgLabel, Me.Font, Brushes.Black, 5, 205 - finalgrade * 2)
        ...
        For TSi As Integer = 0 To quantity.Count - 1
            TSgr.FillRectangle(Brushes.Blue, 90 + TSi * 50, (210 - quantity(TSi) * 2), 30, quantity(TSi) * 2)
            '(x,y,w,h)
        Next
